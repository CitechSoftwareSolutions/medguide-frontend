...
export default function ChatPage() {
  ...
  return (
    <div className="app">
      <div style={{ display: 'flex', flexDirection: 'column', background: 'var(--blue-50)', borderRight: '1px solid var(--gray-200)' }}>
        <button onClick={() => navigate('/')} style={{
          background: 'none', border: 'none', borderBottom: '1px solid var(--gray-200)',
          padding: '16px', color: 'var(--blue-700)', cursor: 'pointer',
